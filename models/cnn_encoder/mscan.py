...
#         init_cfg = dict(type='Pretrained', checkpoint=cfg.mscan_checkpoint)
#         drop_path_rate = 0.1
#     elif cfg.mscan == 'large':
#         embed_dims = [64, 128, 320, 512]
#         depths = [3, 5, 27, 3]
#         init_cfg = dict(type='Pretrained', checkpoint=cfg.mscan_checkpoint)
#         drop_path_rate = 0.3
#     return embed_dims, depths, init_cfg, drop_path_rate
...
# class Mscan_Encoder(nn.Module):
#     def __init__(self, args):
#         super().__init__()
#         self.channels, self.depths, self.init_cfg, self.drop_path_rate = get_mscan_model_shape(args)
#         self.model = MSCAN(embed_dims=self.channels, depths=self.depths,
#                            init_cfg=self.init_cfg, drop_path_rate=self.drop_path_rate)
...
#         features = self.model.get_blocks(inputs, H, W)
